...
import atualizarCotacaoDaSimulacao from '@salesforce/apex/CotacaoController.atualizarCotacaoDaSimulacao';
...
export default class SimuladorDeVendas extends NavigationMixin(LightningElement) {
    ...
    concluirSimulacao(){
        ...
        let cotacaoParaAtualizar = {
            Id: this.getCotacaoId,
            PorcentagemCaptacaoProposta__c: (this.valorNominalProposta / this.valorNominalTabelaSelecionada) * 100,
            ValorNominalTabela__c: this.valorNominalTabelaSelecionada.toString(),
            ValorNominalProposta__c: this.valorNominalProposta.toString(),
            ValorVPLTabela__c: this.valorVplTabelaSelecionada.toString(),
            ValorVPLProposta__c: this.valorVplProposta.toString(),
            DiferencaNominalReal__c: this.valorNominalProposta - this.valorNominalTabelaSelecionada,
            DiferencaNominalPorcentagem__c: ((this.valorNominalProposta - this.valorNominalTabelaSelecionada) / this.valorNominalTabelaSelecionada) * 100,
            DiferencaVPLReal__c: this.valorVplProposta - this.valorVplTabelaSelecionada,
            DiferencaVPLPorcentagem__c: ((this.valorVplProposta - this.valorVplTabelaSelecionada) / this.valorVplTabelaSelecionada) * 100
            }            
        ...
        atualizarCotacaoDaSimulacao({cotacao: cotacaoParaAtualizar})
        .then(result=>{
            console.log("cotacao atualizada: "+ JSON.stringify(result))
            console.log(JSON.stringify(this.valorVplProposta.toString()))
            this.showNotification("Simulação concluída com sucesso!", "success")
